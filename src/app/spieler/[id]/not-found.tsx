  ...
  return (
    <div className="min-h-[calc(100svh-3.5rem)] bg-asphalt">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        <p className="text-foam-muted">
          Diese Rückennummer steht nicht auf der Dummy-Liste.
        </p>
        <Link
          href="/"
          className="mt-6 inline-block bg-amber px-5 py-3 font-display uppercase tracking-wide text-asphalt"
        >
          Zum Leaderboard
        </Link>
      </div>
